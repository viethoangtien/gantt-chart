package com.example.mylibrary.dev;
...
import com.example.mylibrary.dev.model.Project;
import com.example.mylibrary.dev.model.SubTask;
import com.example.mylibrary.dev.model.Task;
import com.example.mylibrary.dev.view.BarView;
import com.example.mylibrary.dev.view.CalendarView;
import com.example.mylibrary.dev.view.ScaleView;
import com.example.mylibrary.dev.view.SubtaskBarView;
...
public class GanttTableAdapter extends BaseTableAdapter {
    ...
    private View getProjectView(View convertView) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_table_pj, null);
        }
        ((TextView) convertView.findViewById(R.id.project_name)).setText(project.getName());
        return convertView;
    }

    private View getCalendarView(View convertView) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_table_cal, null);
        }
    ...
    private View getListView(View convertView) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_table_list, null);
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            TextView task = (TextView) LayoutInflater.from(context).inflate(R.layout.division_group, null);
...
//            }
        ...
        TextView parentTask = (TextView) LayoutInflater.from(context).inflate(R.layout.division_group, null);
    ...
    private View getGanttView(View convertView) {
        ViewHolder holder;
        if (convertView == null || convertView.getTag() == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_table_gantt, null);
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            BarView task_bar = new BarView(context);
            ...
            for (int j = 0; j < _children.size(); j++) {
                ...
                SubtaskBarView subtask_bar = new SubtaskBarView(context);
